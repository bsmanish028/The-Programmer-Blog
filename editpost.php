...
<?php
	...
	if(empty($Title)){
			...
			global $Connection;
			$EditQueryID = $_GET['id'];
			$Insert_Query = "UPDATE admin_panel SET datetime='$DateTime', title='$Title' ,category='$Category', author='$Admin',image='$Image',post='$Post' WHERE id='$EditQueryID' ";
...
<html>
<head>
	<title>Edit Post | Update Post</title>
			...
			<div class="col-sm-10">
				...
				<div>
					...
					<div class="form-group">
						...
						<input value="<?php echo $NewTitle; ?>" class="form-control" type="text" name="Title" id="title" placeholder="Title ">
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="postarea" name="Post"><?php echo $NewPost; ?></textarea>
					</div>
					<br>
