		...
		<div class="row">
			<div class="col-sm-8"><!---Main Area-->
				<?php
					...
					//Query is active while pagination is active like user search parameter like blog.php?Page=2
					...
					//Default Query : Query Active when user visit the blog page blog.php
					else{
